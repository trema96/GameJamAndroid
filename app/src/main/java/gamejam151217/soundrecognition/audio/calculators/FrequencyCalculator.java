package gamejam151217.soundrecognition.audio.calculators;

import java.util.Arrays;

import gamejam151217.soundrecognition.audio.calculators.RealDoubleFFT;
...
public class FrequencyCalculator {
    ...
    public double[] getSpectrumAmpOutDB() {
        if (nAnalysed != 0) {
        ...
        return Arrays.copyOf(spectrumAmpOutDB, spectrumAmpOutDB.length);
    }
